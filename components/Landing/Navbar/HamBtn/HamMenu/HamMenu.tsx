...
const HamMenu: React.FC<HamMenuProps> = ({isHamOpen}) => {
    ...
    const animate = () => {
        if (isHamOpen) {
            ...
            if (typeof window !== 'undefined' && window.innerWidth > 585) {
                tl.to(
                    [
                        [
    ...
    return (
        <>
          {typeof window !== 'undefined' && window.innerWidth > 585 ? (
                <div className={styles.hamMenuLines}>
                    ...
                    <div className={styles.developers} ref={developersRef}>
                        ...
                        <Link
                            onClick={() => handleClick()}
                            href="https://ignitia-2k25-dev-home.vercel.app/"
                    ...
                    <div className={styles.mediaPartners} ref={mediaPartnersRef}>
                        ...
                        <Link
                            onClick={() => handleClick()}
                            href="https://gallery-ignitia.vercel.app/"
                    ...
                    <div className={styles.sponsors} ref={sponsorsRef}>
                        ...
                        <Link
                            onClick={() => handleClick()}
                            href="https://events-ignitia-2k25.vercel.app/"
